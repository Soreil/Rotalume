namespace J2i.Net.XInputWrapper
{
    ...
    [Flags]
    internal enum ControllerSubtypes
    {
    ...
    internal enum BatteryTypes : byte
    {
        //
    ...
    internal class XInputConstants
    {
        internal const int XINPUT_DEVTYPE_GAMEPAD = 0x01;

        //
        // Device subtypes available in XINPUT_CAPABILITIES
        //
        internal const int XINPUT_DEVSUBTYPE_GAMEPAD = 0x01;
        ...
        // Gamepad thresholds
        //
        internal const int XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE = 7849;
        internal const int XINPUT_GAMEPAD_RIGHT_THUMB_DEADZONE = 8689;
        internal const int XINPUT_GAMEPAD_TRIGGER_THRESHOLD = 30;

        //
        // Flags to pass to XInputGetCapabilities
        //
        internal const int XINPUT_FLAG_GAMEPAD = 0x00000001;
