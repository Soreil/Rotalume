...
namespace emulator
{
    public partial class CPU
    {
        ...
        public CPU(Func<bool> getKeyboardInterrupt, MMU memory)
        {
            ...
            StdOps[(int)Unprefixed.LD_AT_BC_A] = LD((WideRegister.BC, Postfix.unchanged), Register.A, 8);
            ...
            StdOps[(int)Unprefixed.LD_B_d8] = LD_D8(Register.B, 8);
            ...
            StdOps[(int)Unprefixed.LD_A_AT_BC] = LD(Register.A, (WideRegister.BC, Postfix.unchanged), 8);
            ...
            StdOps[(int)Unprefixed.LD_C_d8] = LD_D8(Register.C, 8);
            ...
            StdOps[(int)Unprefixed.LD_D_d8] = LD_D8(Register.D, 8);
            StdOps[(int)Unprefixed.RLA] = RLA(4);
            StdOps[(int)Unprefixed.JR_r8] = JR(12);
            StdOps[(int)Unprefixed.ADD_HL_DE] = ADD(WideRegister.DE, 8);
            StdOps[(int)Unprefixed.LD_A_AT_DE] = LD(Register.A, (WideRegister.DE, Postfix.unchanged), 8);
            ...
            StdOps[(int)Unprefixed.LD_E_d8] = LD_D8(Register.E, 8);
            ...
            StdOps[(int)Unprefixed.LDI_AT_HL_A] = LD((WideRegister.HL, Postfix.increment), Register.A, 8);
            ...
            StdOps[(int)Unprefixed.LD_H_d8] = LD_D8(Register.H, 8);
            ...
            StdOps[(int)Unprefixed.LD_AI_AT_HL] = LD(Register.A, (WideRegister.HL, Postfix.increment), 8);
            ...
            StdOps[(int)Unprefixed.LD_L_d8] = LD_D8(Register.L, 8);
            ...
            StdOps[(int)Unprefixed.LDD_AT_HL_A] = LD((WideRegister.HL, Postfix.decrement), Register.A, 8);
            ...
            StdOps[(int)Unprefixed.LD_AT_HL_d8] = LD_D8(Register.HL, 12);
            ...
            StdOps[(int)Unprefixed.LD_AD_AT_HL] = LD(Register.A, (WideRegister.HL, Postfix.decrement), 8);
            ...
            StdOps[(int)Unprefixed.LD_A_d8] = LD_D8(Register.A, 8);
            StdOps[(int)Unprefixed.CCF] = CCF(4);
            StdOps[(int)Unprefixed.LD_B_B] = LD((Register.B, true), (Register.B, true), 4);
            StdOps[(int)Unprefixed.LD_B_C] = LD((Register.B, true), (Register.C, true), 4);
            StdOps[(int)Unprefixed.LD_B_D] = LD((Register.B, true), (Register.D, true), 4);
            StdOps[(int)Unprefixed.LD_B_E] = LD((Register.B, true), (Register.E, true), 4);
            StdOps[(int)Unprefixed.LD_B_H] = LD((Register.B, true), (Register.H, true), 4);
            StdOps[(int)Unprefixed.LD_B_L] = LD((Register.B, true), (Register.L, true), 4);
            StdOps[(int)Unprefixed.LD_B_AT_HL] = LD(Register.B, (WideRegister.HL, Postfix.unchanged), 8);
            StdOps[(int)Unprefixed.LD_B_A] = LD((Register.B, true), (Register.A, true), 4);
            StdOps[(int)Unprefixed.LD_C_B] = LD((Register.C, true), (Register.B, true), 4);
            StdOps[(int)Unprefixed.LD_C_C] = LD((Register.C, true), (Register.C, true), 4);
            StdOps[(int)Unprefixed.LD_C_D] = LD((Register.C, true), (Register.D, true), 4);
            StdOps[(int)Unprefixed.LD_C_E] = LD((Register.C, true), (Register.E, true), 4);
            StdOps[(int)Unprefixed.LD_C_H] = LD((Register.C, true), (Register.H, true), 4);
            StdOps[(int)Unprefixed.LD_C_L] = LD((Register.C, true), (Register.L, true), 4);
            StdOps[(int)Unprefixed.LD_C_AT_HL] = LD(Register.C, (WideRegister.HL, Postfix.unchanged), 8);
            StdOps[(int)Unprefixed.LD_C_A] = LD((Register.C, true), (Register.A, true), 4);
            StdOps[(int)Unprefixed.LD_D_B] = LD((Register.D, true), (Register.B, true), 4);
            StdOps[(int)Unprefixed.LD_D_C] = LD((Register.D, true), (Register.C, true), 4);
            StdOps[(int)Unprefixed.LD_D_D] = LD((Register.D, true), (Register.D, true), 4);
            StdOps[(int)Unprefixed.LD_D_E] = LD((Register.D, true), (Register.E, true), 4);
            StdOps[(int)Unprefixed.LD_D_H] = LD((Register.D, true), (Register.H, true), 4);
            StdOps[(int)Unprefixed.LD_D_L] = LD((Register.D, true), (Register.L, true), 4);
            StdOps[(int)Unprefixed.LD_D_AT_HL] = LD(Register.D, (WideRegister.HL, Postfix.unchanged), 8);
            StdOps[(int)Unprefixed.LD_D_A] = LD((Register.D, true), (Register.A, true), 4);
            StdOps[(int)Unprefixed.LD_E_B] = LD((Register.E, true), (Register.B, true), 4);
            StdOps[(int)Unprefixed.LD_E_C] = LD((Register.E, true), (Register.C, true), 4);
            StdOps[(int)Unprefixed.LD_E_D] = LD((Register.E, true), (Register.D, true), 4);
            StdOps[(int)Unprefixed.LD_E_E] = LD((Register.E, true), (Register.E, true), 4);
            StdOps[(int)Unprefixed.LD_E_H] = LD((Register.E, true), (Register.H, true), 4);
            StdOps[(int)Unprefixed.LD_E_L] = LD((Register.E, true), (Register.L, true), 4);
            StdOps[(int)Unprefixed.LD_E_AT_HL] = LD(Register.E, (WideRegister.HL, Postfix.unchanged), 8);
            StdOps[(int)Unprefixed.LD_E_A] = LD((Register.E, true), (Register.A, true), 4);
            StdOps[(int)Unprefixed.LD_H_B] = LD((Register.H, true), (Register.B, true), 4);
            StdOps[(int)Unprefixed.LD_H_C] = LD((Register.H, true), (Register.C, true), 4);
            StdOps[(int)Unprefixed.LD_H_D] = LD((Register.H, true), (Register.D, true), 4);
            StdOps[(int)Unprefixed.LD_H_E] = LD((Register.H, true), (Register.E, true), 4);
            StdOps[(int)Unprefixed.LD_H_H] = LD((Register.H, true), (Register.H, true), 4);
            StdOps[(int)Unprefixed.LD_H_L] = LD((Register.H, true), (Register.L, true), 4);
            StdOps[(int)Unprefixed.LD_H_AT_HL] = LD(Register.H, (WideRegister.HL, Postfix.unchanged), 8);
            StdOps[(int)Unprefixed.LD_H_A] = LD((Register.H, true), (Register.A, true), 4);
            StdOps[(int)Unprefixed.LD_L_B] = LD((Register.L, true), (Register.B, true), 4);
            StdOps[(int)Unprefixed.LD_L_C] = LD((Register.L, true), (Register.C, true), 4);
            StdOps[(int)Unprefixed.LD_L_D] = LD((Register.L, true), (Register.D, true), 4);
            StdOps[(int)Unprefixed.LD_L_E] = LD((Register.L, true), (Register.E, true), 4);
            StdOps[(int)Unprefixed.LD_L_H] = LD((Register.L, true), (Register.H, true), 4);
            StdOps[(int)Unprefixed.LD_L_L] = LD((Register.L, true), (Register.L, true), 4);
            StdOps[(int)Unprefixed.LD_L_AT_HL] = LD(Register.L, (WideRegister.HL, Postfix.unchanged), 8);
            StdOps[(int)Unprefixed.LD_L_A] = LD((Register.L, true), (Register.A, true), 4);
            StdOps[(int)Unprefixed.LD_AT_HL_B] = LD((WideRegister.HL, Postfix.unchanged), Register.B, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_C] = LD((WideRegister.HL, Postfix.unchanged), Register.C, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_D] = LD((WideRegister.HL, Postfix.unchanged), Register.D, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_E] = LD((WideRegister.HL, Postfix.unchanged), Register.E, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_H] = LD((WideRegister.HL, Postfix.unchanged), Register.H, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_L] = LD((WideRegister.HL, Postfix.unchanged), Register.L, 8);
            StdOps[(int)Unprefixed.HALT] = HALT(4);
            StdOps[(int)Unprefixed.LD_AT_HL_A] = LD((WideRegister.HL, Postfix.unchanged), Register.A, 8);
            StdOps[(int)Unprefixed.LD_A_B] = LD((Register.A, true), (Register.B, true), 4);
            StdOps[(int)Unprefixed.LD_A_C] = LD((Register.A, true), (Register.C, true), 4);
            StdOps[(int)Unprefixed.LD_A_D] = LD((Register.A, true), (Register.D, true), 4);
            StdOps[(int)Unprefixed.LD_A_E] = LD((Register.A, true), (Register.E, true), 4);
            StdOps[(int)Unprefixed.LD_A_H] = LD((Register.A, true), (Register.H, true), 4);
            StdOps[(int)Unprefixed.LD_A_L] = LD((Register.A, true), (Register.L, true), 4);
            StdOps[(int)Unprefixed.LD_A_AT_HL] = LD(Register.A, (WideRegister.HL, Postfix.unchanged), 8);
            StdOps[(int)Unprefixed.LD_A_A] = LD((Register.A, true), (Register.A, true), 4);
            ...
            StdOps[(int)Unprefixed.JP_a16] = JP_A16(16);
            ...
            StdOps[(int)Unprefixed.LD_AT_C_A] = LD((Register.C, false), (Register.A, true), 8);
            ...
            StdOps[(int)Unprefixed.LD_A_AT_C] = LD((Register.A, true), (Register.C, false), 8);
            ...
            StdOps[(int)Unprefixed.LD_A_AT_a16] = LD_A16(16);
