...
namespace emulator
{
    public partial class CPU
    {
        ...
        private Action[] MakeTable()
        {
            ...
            m[(int)Unprefixed.LD_DE_d16] = LD(WideRegister.DE, DMGInteger.d16, 12);
            m[(int)Unprefixed.LD_BC_d16] = LD(WideRegister.BC, DMGInteger.d16, 12);
            ...
            m[(int)Unprefixed.LD_HL_d16] = LD(WideRegister.HL, DMGInteger.d16, 12);
            ...
            m[(int)Unprefixed.LD_SP_d16] = LD(WideRegister.SP, DMGInteger.d16, 12);
