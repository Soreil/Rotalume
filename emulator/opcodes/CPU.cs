...
namespace emulator
{
    public partial class CPU
    {
        ...
        public CPU(MMU mMU, InterruptRegisters interruptRegisters, ProgramCounter PC)
        {
            ...
            StdOps[(int)Unprefixed.LD_B_B] = LD(Register.B, Register.B, 4);
            StdOps[(int)Unprefixed.LD_B_C] = LD(Register.B, Register.C, 4);
            StdOps[(int)Unprefixed.LD_B_D] = LD(Register.B, Register.D, 4);
            StdOps[(int)Unprefixed.LD_B_E] = LD(Register.B, Register.E, 4);
            StdOps[(int)Unprefixed.LD_B_H] = LD(Register.B, Register.H, 4);
            StdOps[(int)Unprefixed.LD_B_L] = LD(Register.B, Register.L, 4);
            StdOps[(int)Unprefixed.LD_B_AT_HL] = LD(Register.B, Register.HL, 8);
            StdOps[(int)Unprefixed.LD_B_A] = LD(Register.B, Register.A, 4);
            StdOps[(int)Unprefixed.LD_C_B] = LD(Register.C, Register.B, 4);
            StdOps[(int)Unprefixed.LD_C_C] = LD(Register.C, Register.C, 4);
            StdOps[(int)Unprefixed.LD_C_D] = LD(Register.C, Register.D, 4);
            StdOps[(int)Unprefixed.LD_C_E] = LD(Register.C, Register.E, 4);
            StdOps[(int)Unprefixed.LD_C_H] = LD(Register.C, Register.H, 4);
            StdOps[(int)Unprefixed.LD_C_L] = LD(Register.C, Register.L, 4);
            StdOps[(int)Unprefixed.LD_C_AT_HL] = LD(Register.C, Register.HL, 8);
            StdOps[(int)Unprefixed.LD_C_A] = LD(Register.C, Register.A, 4);
            StdOps[(int)Unprefixed.LD_D_B] = LD(Register.D, Register.B, 4);
            StdOps[(int)Unprefixed.LD_D_C] = LD(Register.D, Register.C, 4);
            StdOps[(int)Unprefixed.LD_D_D] = LD(Register.D, Register.D, 4);
            StdOps[(int)Unprefixed.LD_D_E] = LD(Register.D, Register.E, 4);
            StdOps[(int)Unprefixed.LD_D_H] = LD(Register.D, Register.H, 4);
            StdOps[(int)Unprefixed.LD_D_L] = LD(Register.D, Register.L, 4);
            StdOps[(int)Unprefixed.LD_D_AT_HL] = LD(Register.D, Register.HL, 8);
            StdOps[(int)Unprefixed.LD_D_A] = LD(Register.D, Register.A, 4);
            StdOps[(int)Unprefixed.LD_E_B] = LD(Register.E, Register.B, 4);
            StdOps[(int)Unprefixed.LD_E_C] = LD(Register.E, Register.C, 4);
            StdOps[(int)Unprefixed.LD_E_D] = LD(Register.E, Register.D, 4);
            StdOps[(int)Unprefixed.LD_E_E] = LD(Register.E, Register.E, 4);
            StdOps[(int)Unprefixed.LD_E_H] = LD(Register.E, Register.H, 4);
            StdOps[(int)Unprefixed.LD_E_L] = LD(Register.E, Register.L, 4);
            StdOps[(int)Unprefixed.LD_E_AT_HL] = LD(Register.E, Register.HL, 8);
            StdOps[(int)Unprefixed.LD_E_A] = LD(Register.E, Register.A, 4);
            StdOps[(int)Unprefixed.LD_H_B] = LD(Register.H, Register.B, 4);
            StdOps[(int)Unprefixed.LD_H_C] = LD(Register.H, Register.C, 4);
            StdOps[(int)Unprefixed.LD_H_D] = LD(Register.H, Register.D, 4);
            StdOps[(int)Unprefixed.LD_H_E] = LD(Register.H, Register.E, 4);
            StdOps[(int)Unprefixed.LD_H_H] = LD(Register.H, Register.H, 4);
            StdOps[(int)Unprefixed.LD_H_L] = LD(Register.H, Register.L, 4);
            StdOps[(int)Unprefixed.LD_H_AT_HL] = LD(Register.H, Register.HL, 8);
            StdOps[(int)Unprefixed.LD_H_A] = LD(Register.H, Register.A, 4);
            StdOps[(int)Unprefixed.LD_L_B] = LD(Register.L, Register.B, 4);
            StdOps[(int)Unprefixed.LD_L_C] = LD(Register.L, Register.C, 4);
            StdOps[(int)Unprefixed.LD_L_D] = LD(Register.L, Register.D, 4);
            StdOps[(int)Unprefixed.LD_L_E] = LD(Register.L, Register.E, 4);
            StdOps[(int)Unprefixed.LD_L_H] = LD(Register.L, Register.H, 4);
            StdOps[(int)Unprefixed.LD_L_L] = LD(Register.L, Register.L, 4);
            StdOps[(int)Unprefixed.LD_L_AT_HL] = LD(Register.L, Register.HL, 8);
            StdOps[(int)Unprefixed.LD_L_A] = LD(Register.L, Register.A, 4);
            StdOps[(int)Unprefixed.LD_AT_HL_B] = LD(Register.HL, Register.B, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_C] = LD(Register.HL, Register.C, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_D] = LD(Register.HL, Register.D, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_E] = LD(Register.HL, Register.E, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_H] = LD(Register.HL, Register.H, 8);
            StdOps[(int)Unprefixed.LD_AT_HL_L] = LD(Register.HL, Register.L, 8);
            StdOps[(int)Unprefixed.HALT] = HALT(4);
            StdOps[(int)Unprefixed.LD_AT_HL_A] = LD(Register.HL, Register.A, 8);
            StdOps[(int)Unprefixed.LD_A_B] = LD(Register.A, Register.B, 4);
            StdOps[(int)Unprefixed.LD_A_C] = LD(Register.A, Register.C, 4);
            StdOps[(int)Unprefixed.LD_A_D] = LD(Register.A, Register.D, 4);
            StdOps[(int)Unprefixed.LD_A_E] = LD(Register.A, Register.E, 4);
            StdOps[(int)Unprefixed.LD_A_H] = LD(Register.A, Register.H, 4);
            StdOps[(int)Unprefixed.LD_A_L] = LD(Register.A, Register.L, 4);
            StdOps[(int)Unprefixed.LD_A_AT_HL] = LD(Register.A, Register.HL, 8);
            StdOps[(int)Unprefixed.LD_A_A] = LD(Register.A, Register.A, 4);
            ...
            StdOps[(int)Unprefixed.ADD_A_AT_HL] = ADD(Register.A, Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.ADC_A_AT_HL] = ADC(Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.SUB_AT_HL] = SUB(Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.SBC_A_AT_HL] = SBC(Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.AND_AT_HL] = AND(Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.XOR_AT_HL] = XOR(Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.OR_AT_HL] = OR(Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.CP_AT_HL] = CP(Register.HL, 8);
            ...
            StdOps[(int)Unprefixed.LD_AT_C_A] = LD_AT_C_A(8);
            ...
            StdOps[(int)Unprefixed.LD_A_AT_C] = LD_A_AT_C(8);
