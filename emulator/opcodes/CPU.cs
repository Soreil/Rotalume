...
namespace emulator
{
    public partial class CPU
    {
        ...
        public CPU(MMU mMU, InterruptRegisters interruptRegisters, ProgramCounter PC)
        {
            ...
            StdOps[(int)Opcode.ADD_A_B] = ADD(Register.A, Register.B, 4);
            StdOps[(int)Opcode.ADD_A_C] = ADD(Register.A, Register.C, 4);
            StdOps[(int)Opcode.ADD_A_D] = ADD(Register.A, Register.D, 4);
            StdOps[(int)Opcode.ADD_A_E] = ADD(Register.A, Register.E, 4);
            StdOps[(int)Opcode.ADD_A_H] = ADD(Register.A, Register.H, 4);
            StdOps[(int)Opcode.ADD_A_L] = ADD(Register.A, Register.L, 4);
            StdOps[(int)Opcode.ADD_A_AT_HL] = ADD(Register.A, Register.HL, 8);
            StdOps[(int)Opcode.ADD_A_A] = ADD(Register.A, Register.A, 4);
